...
Scripts live in `${extensionPath}/scripts/`; they are named bare below. When the caller hands
...
- Ours come from the findings catalog,
  `${extensionPath}/skills/fleet-diagnostics/references/findings-catalog.md` (`fleet.*`), with
